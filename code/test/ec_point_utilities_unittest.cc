...
TEST(point_is_on_curve, DISABLED_point_inf)
{
    ...
    Point p;
    create_point_from_uint64(&p, BI_TESTS_PINFX_TAG, BI_TESTS_PINFY_TAG, 2, 3);
    p.is_at_infinity = 1;
...
TEST(point_is_on_curve, DISABLED_point_on_curve)
{
    ...
    Point q;
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 16, 10);
    ASSERT_TRUE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 17, 7);
    ASSERT_TRUE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 27, 22);
    ASSERT_TRUE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 1, 8);
    ASSERT_TRUE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 3, 23);
    ASSERT_TRUE(point_is_on_curve(&q, &params));
...
TEST(point_is_on_curve, point_not_on_curve)
{
    ...
    Point q;
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 0, 0);
    ASSERT_FALSE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 17, 8);
    ASSERT_FALSE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 27, 21);
    ASSERT_FALSE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 1, 4);
    ASSERT_FALSE(point_is_on_curve(&q, &params));
    create_point_from_uint64(&q, BI_TESTS_QX_TAG, BI_TESTS_QY_TAG, 3, 12);
    ASSERT_FALSE(point_is_on_curve(&q, &params));
...
TEST(point_are_equal, inf)
{
    ...
    create_point(&p, x, y);
    create_point_from_uint64(&q, BI_TESTS_PINFX_TAG, BI_TESTS_PINFY_TAG, 34, 0);
    q.is_at_infinity = 1;
